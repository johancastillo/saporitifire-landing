  ...
  <div class="row">
    ...
    <div class="col-md-6 mb-4">
        <div class="card p-5 text-center">
          <img src="assets/images/benefits/1.svg" width="90px" alt="">
    ...
    <div class="col-md-6 mb-4">
        <div class="card p-5 text-center">
          <img src="assets/images/benefits/2.svg" width="90px" alt="">
    ...
    <div class="col-md-6 mb-4">
        <div class="card p-5 text-center">
          <img src="assets/images/benefits/3.svg" width="90px" alt="">
    ...
    <div class="col-md-6 mb-4">
        <div class="card p-5 text-center">
          <img src="assets/images/benefits/4.svg" width="90px" alt="">
